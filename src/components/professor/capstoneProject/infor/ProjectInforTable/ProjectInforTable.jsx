...
export default class ProjectInforTable extends Component {
  render() {
      const {courseTheme,projectId,title,description} = this.props.projectInfor
    return (
      <div>
            <section id="project-information" style={{marginTop: 0, height: 'auto'}}>
                ...
                <div className="row">
                    ...
                    <h1 style={{fontFamily: 'Actor, sans-serif', color: '#9f2536'}}><strong>Project1:&nbsp;{projectId}</strong><br /></h1>
                    </div>
                </div>

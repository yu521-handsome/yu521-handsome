...
export default class QuizInforTable extends Component {
  render() {
    const {courseTheme,quizId,title,description} = this.props.quizInfor
    return (
      <div>
            <section id="quiz-information" style={{marginTop: 0, height: 'auto'}}>
                ...
                <div className="row">
                    ...
                    <h1 style={{fontFamily: 'Actor, sans-serif', color: '#9f2536'}}><strong>Quiz:&nbsp;{quizId}</strong><br /></h1>
                    </div>
                </div>

            ...
            <div>        
                <div className="p-5 mb-4 bg-light round-3" style={{marginTop: '7%'}}>
                    <div className="container-fluid py-5">
                        ...
                        <form className="contact-clean" style={{background: 'rgb(248,249,250)', marginLeft: 0, marginRight: 0, paddingLeft: 0, paddingRight: '40%'}}>
                        <div style={{height: '50%'}}>
                            <small className="form-text" style={{color: 'rgb(0,0,0)', fontSize: 15}}>Course ID</small>
                            <input className="form-control" type="text" placeholder="Enter Course ID" /></div>

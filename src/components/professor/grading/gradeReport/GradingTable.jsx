...
export default class GradingTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <section id="report-grade" style={{background: 'rgba(159,37,54,0.05)'}}>
                        ...
                        <div className="col">
                            ...
                            <div className="col-xl-10 col-xxl-9">
                                ...
                                <div className="card-footer">
                                    <nav>
                                        <PageNav totalPage = { Math.ceil(this.state.reportRecords.length/this.state.listNumber)} changeCurrent = {this.changeCurrent}/>
                                    </nav>
                                </div>

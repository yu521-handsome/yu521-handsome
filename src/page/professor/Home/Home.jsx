  ...
  render() {
    ...
    <div>
            ...
            <div className="container"><a className="navbar-brand" href="#page-top">TCPCM</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" className="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i className="fa fa-bars"></i></button>
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    <ul className="navbar-nav ms-auto text-uppercase">
                        ...
                        <li className="nav-item"><a className="nav-link" href="index.html"><i className="fa fa-home" style={{width: '24.375px',fontSize: '24.4px'}}></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section id="functions">
            <div className="container">
                ...
                <div className="row text-center">
                    <div className="col-md-4"><Link id="capstone-project" to="/professor/capstoneProject/infor"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-flag fa-stack-1x fa-inverse"></i></span></Link>
                    ...
                    <div className="col-md-4"><Link id="acccount-setup" to="/professor/accountSetup"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-link fa-stack-1x fa-inverse"></i></span></Link>
                    ...
                    <div className="col-md-4"><Link to="/professor/studentGrouping"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-group fa-stack-1x fa-inverse"></i></span></Link>
                ...
                <div className="row text-center">
                    <div className="col-md-4"><Link to="/professor/grading"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-graduation-cap fa-stack-1x fa-inverse"></i></span></Link>
                    ...
                    <div className="col-md-4"><Link to="/professor/courseReport"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-file-o fa-stack-1x fa-inverse"></i></span></Link>
                    ...
                    <div className="col-md-4"><Link to="/professor/badgeSetting"><span className="fa-stack fa-4x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fa fa-lock fa-stack-1x fa-inverse"></i></span></Link>
        ...
        <section className="bg-light" id="profile">
            <div className="container">
                <div className="row" style={{height: '121px'}}>
                ...
                <div className="row" style={{background: "linear-gradient(black 0%, white 0%)",height: '200%',width: '102%'}}>
                    ...
                    <div className="col-lg-7 col-xl-7 col-xxl-12" style={{width: 'auto',height: '80%',background: '#ffffff'}}>
                        <h2 style={{marginTop: '20px'}}>Prof. CW Brian KEI</h2>
                        ...
                        <form style={{marginTop: '-51px'}}>
                            <div className="row" id="infor1">
                                <div className="col">
                                    <h5 style={{marginTop: '6px', letterSpacing: '-1px'}}>Email Address</h5>
                                </div>
                                <div className="col-lg-8"><input className="form-control-plaintext" type="text" value="cw-brian.kei@polyu.edu.hk" readonly=""/></div>
                            </div>
                            <div className="row" id="infor-2">
                                <div className="col">
                                    <h5 style={{marginTop: '6px', letterSpacing: '-1px'}}>Phone Number&nbsp;</h5>
                                </div>
                                <div className="col-lg-8"><input className="form-control-plaintext" type="text" value="3400 3953" readonly=""/></div>
                            </div>
                            <div className="row" id="infor-3">
                                <div className="col">
                                    <h5 style={{marginTop: '6px', letterSpacing: '-1px'}}>Office</h5>
                                </div>
                                <div className="col-lg-8"><input className="form-control-plaintext" type="text" value="M505D" readonly=""/></div>
                            </div>
                            <div className="row" id="infor-4">
                                <div className="col">
                                    <h5 style={{marginTop: '6px', letterSpacing: '-1px'}}>Research Area</h5>
                                </div>
                                <div className="col-lg-8"><input className="form-control-plaintext" type="text" value="Financial Services, Fintech and Technology Innovation" readonly=""/></div>
                            </div>
                            <div className="row" id="infor-5">
                                <div className="col">
                                    <h5 style={{marginTop: '6px', letterSpacing: '-1px'}}><strong>Consulting, Research and Teaching Interests</strong></h5>
                                </div>

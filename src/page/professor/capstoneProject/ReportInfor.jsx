            ...
            <div id="item-1-4" className="tab-pane fade" role="tabpanel" aria-labelledby="item-1-4-tab">
                ...
                <section id="report-information" style={{marginTop: 0, height: 'auto'}}>
                    ...
                    <div className="row">
                        ...
                        <h1 style={{fontFamily: 'Actor, sans-serif', color: '#9f2536'}}><strong>Report1:&nbsp;AF4912BDBKEIR1</strong><br /></h1>
                        </div>
                    </div>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            ...
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                                <p style={{width: '80%', height: '60%', fontFamily: 'Actor, sans-serif', borderWidth: 1, borderLeftStyle: 'none', marginTop: 5, marginLeft: 0}}>First Semester Report</p>
                            </div>
                            </div>
                        </form>
                        </div>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'solid'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 201, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Report Due Date</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>

    ...
    return (
        <div>
            <div className="tab-pane fade show active" role="tabpanel">
                ...
                <section id="project-information" style={{marginTop: 0, height: 'auto'}}>
                    ...
                    <div className="row">
                        ...
                        <h1 style={{fontFamily: 'Actor, sans-serif', color: '#9f2536'}}><strong>Project1:&nbsp;AF4912BDBKEIP1</strong><br /></h1>
                        </div>
                    </div>
                    <div className="row" id="heading-basic-information-1">
                        <div className="col" style={{height: '50%'}}>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'solid'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 201, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Project Name</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                                <p style={{width: '80%', height: '60%', fontFamily: 'Actor, sans-serif', borderWidth: 1, borderLeftStyle: 'none', marginTop: 5, marginLeft: 0}}>First Semester Project</p>
                            </div>
                            </div>
                        </form>
                        </div>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'initial'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 201, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Project Description</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'solid'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 201, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Project Due Date</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>

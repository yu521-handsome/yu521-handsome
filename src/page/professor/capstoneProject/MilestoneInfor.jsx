...
export default class MilestoneInfor extends Component {
  render() {
    return (
        <div>
            <div className="tab-pane fade show active" role="tabpanel">
                ...
                <section id="milestone-information" style={{height: 'auto', marginTop: 0}}>
                    ...
                    <div className="row">
                        ...
                        <h1 style={{fontFamily: 'Actor, sans-serif', color: '#9f2536'}}><strong>Milestone1:&nbsp;AF4912BDBKEIM1</strong><br /></h1>
                        </div>
                    </div>
                    <div className="row" id="heading-basic-information-4">
                        <div className="col" style={{height: '50%'}}>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'solid'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 400, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Professional Short Course</strong><br /></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'initial'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 400, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Milestone&nbsp;Description</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                    ...
                    <div className="row" style={{background: 'rgba(239,239,239,0.4)'}}>
                        ...
                        <form>
                            <div className="row" style={{height: '50%', borderWidth: 1, borderStyle: 'solid'}}>
                            <div className="col" style={{width: 400, height: 'auto'}}>
                                <p style={{width: 201, height: 28, marginTop: 5, fontSize: 22, fontFamily: 'Actor, sans-serif', marginLeft: '-4px', borderWidth: 1, fontWeight: 'bold', textAlign: 'left'}}><strong>Submission Due Date</strong></p>
                            </div>
                            <div className="col-lg-8" style={{width: '574.328px', borderWidth: 10, height: 'auto', margin: '-1px'}}>
                    ...
                    <div className="dropdown" style={{marginTop: '10%'}}><button className="btn btn-primary dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button">Change Information&nbsp;</button>
                        <div className="dropdown-menu"><a className="dropdown-item" href="P-1.6.2.Professor%20milestone%20change%20information.html">Milestone 1</a><a className="dropdown-item" href="P-1.6.2.Professor%20milestone%20change%20information.html">Milestone 2</a><a className="dropdown-item" href="P-1.6.2.Professor%20milestone%20change%20information.html">Other Milestones</a></div>
                    </div>
                    </div>
                </section>
            </div>
